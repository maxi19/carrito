...
/**
 * REST controller for managing {@link com.edu.carrito.web.domain.Producto}.
 */
@RestController
...
public class ProductoResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ProductoDTO>> getAllProductos(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
